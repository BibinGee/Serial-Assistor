...
class Application(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle('FHK Sweep Data Assistor Beta V0.7    Copyright@ Daniel Gee')
    ...
    def initGui(self):
        ...
        h3.addWidget(self.step_label)
        
        self.step_edit = QLineEdit(self)
        self.step_edit.setText('0.0')
        h3.addWidget(self.step_edit)
            ...
            if self.LTC_ser.isOpen():
                try:
                    ...
                    if string != b'':
                        ...
                        if self.line != '':
                            if self.pre_ltc - median >= float(step):
                                self.pre_ltc = median
                                print('current LTC:', self.pre_ltc)
                                t = time.strftime ('[%H:%M:%S]:>', time.localtime ())
